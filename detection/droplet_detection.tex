...
Lastly, before applying the model to the images, they are normalized to the interval $[0,1]$ using ImageNet mean and standard deviation to match the training augmentations.
