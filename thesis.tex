...
\begin{document}
    ...
    \input{theory/physics/saw.tex}
    \input{theory/physics/vapourization.tex}
    \input{theory/physics/measurement.tex}

    \newpage
    \chapter{Theory from the perspective of Computer Science}
    \label{sec:theory_compsci}
    \input{theory/compsci/basics/basics.tex}
    \input{theory/compsci/image_segmentation/semanticseg.tex}
    \input{theory/compsci/training/training.tex}
    \input{theory/compsci/classical/hough_transform.tex}

    \chapter{Architectures}
    \label{sec:architectures}
    \input{architecture/introduction.tex}
    \input{architecture/unet.tex}
    \input{architecture/resnet.tex}

    \chapter{Techniques used to improve model accuracy}
    \label{sec:techniques}
    \input{techniques/introduction.tex}
    \input{techniques/transfer_learning/transfer_learning.tex}
    \input{techniques/ssl/mean_teacher.tex}

    \chapter{Droplet detection}
    \label{sec:detection}
    \input{detection/droplet_detection.tex}
    \input{detection/setup.tex}

    \chapter{Experiments and Results}
    \label{sec:experiments}
    \input{experiments/introduction.tex}
    \input{experiments/oversampling.tex}
    \input{experiments/mean_teacher_acc.tex}
    \input{experiments/pretraining.tex}
    \input{experiments/mean_teacher_generalization.tex}
    \input{experiments/binary_labels.tex}
    \input{experiments/reduced_layers.tex}
    \input{experiments/classical.tex}
